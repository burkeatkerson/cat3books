  ...
  return (
    ...
    >
      ...
      <div className="px-[52px] py-20 flex flex-col justify-center relative z-10 md:px-5">
        ...
        <h1 className="animate-fadeUp-d2 font-disp text-[clamp(68px,9vw,124px)] leading-[0.9] tracking-[0.025em] mt-6">
          YOUR BOOKS
          <br />
          ARE A
          <br />
        ...
        <p className="animate-fadeUp-d3 font-cond font-light text-[clamp(18px,2.2vw,26px)] text-c3-mid mt-[26px] leading-[1.4]">
          And you&rsquo;re running your business like{" "}
          <strong className="text-c3-text font-semibold">nothing&rsquo;s wrong.</strong>
        </p>

        <p className="animate-fadeUp-d4 font-body font-light text-base text-c3-mid mt-[22px] leading-[1.9] max-w-[540px]">
        ...
        <div className="animate-fadeUp-d5 mt-8 flex gap-3 flex-wrap">
          <Link
            href="#contact"
