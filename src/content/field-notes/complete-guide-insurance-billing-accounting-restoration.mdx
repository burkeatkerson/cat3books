...
The insured files a claim. The carrier assigns it to an adjuster (staff adjuster or independent adjuster) or routes it through a TPA program. If TPA-routed, the TPA assigns the job to you from their contractor network. The job exists; no billing has occurred yet.
