...
- Build a job-level P&L that separates labor, materials, subcontractors, and equipment costs per job
- Track supplement submissions through carrier approval to final payment
- Code TPA program fees correctly as cost of revenue (not operating expense)
- Reconcile equipment-day billing against logs before a job closes
- Manage the ACV/RCV/holdback AR cycle that's unique to insurance restoration
