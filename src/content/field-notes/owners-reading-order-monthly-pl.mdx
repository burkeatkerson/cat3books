...
featured: false
howToSteps:
  - name: "Check gross margin percentage first"
    text: "Before reading anything else, find gross margin as a percentage of revenue for the month. This single number tells you whether the underlying economics held, improved, or deteriorated."
  - name: "Review revenue mix"
    text: "Look at how revenue was distributed across job types or TPA channels. Mix explains margin variance — a heavier month of TPA-routed jobs will show lower margin than a direct-carrier month at the same revenue."
  - name: "Check overhead trend"
    text: "Look at total overhead as a percentage of revenue versus the prior three months. You are watching for overhead growing in absolute terms faster than revenue is growing."
  - name: "Dig into COGS only if the margin flagged something"
    text: "Only open the cost-of-goods detail if your gross margin was off from your historical average. Look for which of the four cost categories — labor, materials, subs, equipment — is out of proportion."
---
...
*Related reading: [How to Read a Job-Level P&L Like a Restoration Owner](/field-notes/how-to-read-a-job-level-pl) · [The Four Cost Categories Every Restoration Job P&L Must Split](/field-notes/four-cost-categories-restoration-job-pl) · [Is Your Restoration Company Actually Profitable?](/field-notes/is-your-restoration-company-profitable)*
