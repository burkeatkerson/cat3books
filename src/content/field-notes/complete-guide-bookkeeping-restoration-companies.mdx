...
**A properly structured restoration bookkeeping system** produces [job-level P&L](/field-notes/how-to-read-a-job-level-pl) for every project, tracks [supplement receivables](/field-notes/supplements-disappear-xactimate-quickbooks) from submission through collection, and closes the books by the 15th of each month. Companies with this setup catch $15,000–$50,000 in otherwise-missed revenue annually.
...
**What this covers:** Chart of accounts structure, [job costing setup](/field-notes/complete-guide-job-costing-restoration-mitigation), [insurance receivables workflow](/field-notes/complete-guide-insurance-billing-accounting-restoration), [supplement tracking](/field-notes/supplements-disappear-xactimate-quickbooks), TPA fee treatment, [equipment revenue reconciliation](/field-notes/equipment-day-reconciliation-habit), labor burden, the monthly close process, and the key reports you need to run your business. It also covers common mistakes and the decision of when to hire specialized help.
