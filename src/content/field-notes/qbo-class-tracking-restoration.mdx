...
featured: false
howToSteps:
  - name: "Export your existing class list to a spreadsheet"
    text: "Pull all current QBO classes into a spreadsheet so you can audit and map them to the new revenue-channel structure."
  - name: "Map each existing class to a revenue channel"
    text: "Create a mapping table: each old class gets assigned to one of the standard channels — Direct Carrier, TPA program (one per program), Property Management, Retail, Internal."
  - name: "Run bulk reclassification in QBO"
    text: "Use Accountant Tools > Reclassify Transactions to apply the new class structure to the last 12–18 months of historical transactions."
  - name: "Archive old class entries"
    text: "Mark old class entries as inactive in QBO rather than deleting them. Historical reports will still resolve correctly while new transactions use the new structure."
  - name: "Enable required-field enforcement"
    text: "In QBO settings, make Class a required field on every transaction in COGS categories. This prevents unclassified expenses from entering the system going forward."
---
...
*Related reading: [The Four Cost Categories Every Restoration Job P&L Must Split](/field-notes/four-cost-categories-restoration-job-pl) · [The Complete Guide to Bookkeeping for Restoration Companies](/field-notes/complete-guide-bookkeeping-restoration-companies) · [The Complete Guide to Job Costing for Restoration](/field-notes/complete-guide-job-costing-restoration-mitigation)*
