...
featured: false
howToSteps:
  - name: "Pull the active equipment log for all open jobs"
    text: "Every Friday, export or open the active equipment log from your field platform — Encircle, your job management software, or a shared spreadsheet."
  - name: "Compare equipment count in the log to the estimate"
    text: "For each active job, confirm that the unit count in the log matches the unit count on the current Xactimate estimate. Flag any jobs where these numbers differ."
  - name: "Flag day-count discrepancies"
    text: "Check that billing day counts match the actual calendar days from placement date to removal date. Equipment removed but not logged creates unbilled days."
  - name: "Update the Xactimate file before job close"
    text: "Correct any discrepancies in the estimate before the job closes. Corrections after job close become audit issues rather than simple adjustments."
---
...
*Related reading: [The Four Cost Categories Every Restoration Job P&L Must Split](/field-notes/four-cost-categories-restoration-job-pl) · [How to Read a Job-Level P&L Like a Restoration Owner](/field-notes/how-to-read-a-job-level-pl) · [Why Your Supplements Disappear Between Xactimate and QuickBooks](/field-notes/supplements-disappear-xactimate-quickbooks)*
